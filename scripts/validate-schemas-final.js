...
const excludeFiles=['README.md', 'all.schema-store.json', '1.0.0-without-$id.json', '1.0.0.json', '1.1.0-without-$id.json','1.1.0.json', '1.2.0-without-$id.json', '1.2.0.json', '2.0.0-rc1-without-$id.json'];

validationDraft04('draft04', '1.0.0-without-$id.json', '1.2.0.json');

validation(excludeFiles);